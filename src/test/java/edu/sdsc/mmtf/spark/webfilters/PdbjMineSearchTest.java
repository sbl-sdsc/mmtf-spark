...
public class PdbjMineSearchTest {
	private JavaSparkContext sc;
	private JavaPairRDD<String, StructureDataInterface> pdb;

	@Before
	public void setUp() throws Exception {
		SparkConf conf = new SparkConf().setMaster("local[*]").setAppName(PdbjMineSearchTest.class.getSimpleName());
	...
	public void test1() throws IOException {
		...
		assertFalse(matches.contains("1FIN"));
	}
	...
	public void test2() throws IOException {
		...
		assertTrue(matches.contains("5UFU.A"));
