...
/**
 * Example how to map to higher-dimensional tuples. Apache Spark supports Tuple2
 * ... to Tuple19. This example shows how to map to a Tuple4. See also
 * {@link edu.sdsc.mmtf.spark.datasets} for a more scalable alternative to
...
public class MapToTuple4 {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		MmtfReader
				...
				.map(t -> new Tuple4<String, Float, Float, Float>(t._1, t._2.getResolution(), t._2.getRfree(),
						t._2.getRwork()))
