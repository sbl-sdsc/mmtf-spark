 ...
 * @author Yue Yu
 */
public class StructureToBioassembly2 implements PairFlatMapFunction<Tuple2<String,StructureDataInterface>,String, StructureDataInterface> {
...
//						Matrix4f m = new Matrix4f(floatMatrix);
						...
						if(addThisChain){	
							...
							bioAssembly.setChainInfo(structure.getChainIds()[chainIndex]+(k+1), structure.getChainNames()[chainIndex]+(k+1),
