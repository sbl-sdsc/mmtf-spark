...
public final class ExcludedLigandSets {
	...
	public static final Set<String> METAL_CONTAINING;
	public static final Set<String> STABILIZERS;
	public static final Set<String> BUFFERS;
	public static final Set<String> COFACTORS;
	public static final Set<String> COVALENT_MODS;
	public static final Set<String> FRAGMENTS;
	public static final Set<String> EXCIPIENTS;
	public static final Set<String> JUNK;
	...
	static {
		...
		Collections.addAll(junk, "AS8", "PS9", "CYI", "NOB", "DPO", "MDN", "APC", "ACP", "LPT", "PBL", "LFA", "PGW",
				...
				"5HD", "YES", "DIO", "U10", "C14", "BTM", "P03", "M21", "PGV", "LNK", "EGC", "BU3", "R16", "4E6", "1EY",
		...
		Collections.addAll(doNotCall, "CP", "NFU", "NFR", "NFE", "NFV", "FSO", "WCC", "TCN", "FS2", "PDV", "CPT",
				...
				"7PE", "M2M", "13P", "3PP", "PX4", "3OL", "OC9", "AE3", "211", "ODI", "DIA", "PG5", "CXE", "ME2", "P4G",
				"TOE", "PE8", "ZPG", "MXE", "MPO", "NHE", "CXS", "T3A", "3CX", "3FX", "PIN", "MGD", "NAD", "NAP", "NDP",
				"FAD", "FMN", "BH4", "BPH", "BTN", "COA", "ACO", "U10", "HEM", "HEC", "HEA", "HAS", "DHE", "BCL", "CLA",
				"6HE", "7HE", "H4B", "BCB", "CHL", "SXN", "QUY", "UDG", "CBY", "ST9", "25A", "B12", "BPB", "IPE", "PLP",
				"PMP", "TPP", "TDP", "SO4", "SUL", "CL", "BR", "CA", "MG", "NI", "MN", "CU", "PO4", "CD", "NH4", "CO",
				"NA", "K", "ZN", "FE", "AZI", "CD2", "YG", "CR", "CR2", "CR3", "CAC", "CO2", "CO3", "CYN", "FS4", "MO6",
				"NCO", "NO3", "SCN", "SF4", "SE", "PB", "AU", "AU3", "BR1", "CA2", "CL1", "CS", "CS1", "CU1", "AG",
				"AG1", "AL", "AL3", "F", "FE2", "FE3", "IR", "IR3", "KR", "MAL", "GOL", "MPD", "PEG", "EDO", "PG4",
				"BOG", "HTO", "ACX", "CEG", "XLS", "C8E", "CE9", "CRY", "DOX", "EGL", "P6G", "SUC", "1PE", "OLC", "POP",
				"MES", "EPE", "PYR", "CIT", "FLC", "TAR", "HC4", "MYR", "HED", "DTT", "BME", "TRS", "ABA", "ACE", "ACT",
				"CME", "CSD", "CSO", "DMS", "EOH", "FMT", "GTT", "IMD", "IOH", "IPA", "LDA", "LLP", "PEP", "PXY", "OXE",
				"TMT", "TMZ", "2CV", "PLQ", "TAM", "1PG", "12P", "XP4", "PL3", "PE4", "PEU", "MPG", "B8M", "BOM", "B7M",
				"2PE", "STE", "DME", "PLM", "PG0", "PE5", "PG6", "P33", "HEZ", "F23", "DTV", "SDS", "DTU", "DTD", "MRD",
				"MRY", "BU1", "LHG", "D10", "OCT", "LI1", "ETE", "TZZ", "DEP", "DKA", "OLA", "ACD", "MLR", "POG", "BTB",
				"PC1", "ACY", "3GD", "MAE", "CA3", "144", "0KA", "A71", "UVW", "BET", "PBU", "SER", "CDL", "CEY", "LMN",
				"J7Z", "SIN", "PLC", "FNE", "FUM", "MAK", "PAE", "DTL", "HLT", "FPP", "FII", "D1D", "PCT", "TTN", "HDA",
				"PGA", "XXD", "INS", "217", "BHL", "16D", "HSE", "OPE", "HCS", "SOR", "SKM", "KIV", "FCN", "TRA", "TRC",
				"MTL", "KDG", "DHK", "Ar", "IOD", "35N", "HGB", "3UQ", "UNX", "GSH", "DGD", "LMG", "LMT", "CAD", "CUA",
