...
public class ContainsDProteinChain implements Function<Tuple2<String, StructureDataInterface>, Boolean> {
	 ...
	 * As an example, an D-protein/L-DNA complex passes this filter.
	 */
	 ...
	 * For example, with "exclusive" set to true, anDL-protein/L-DNA complex does not pass this filter.
