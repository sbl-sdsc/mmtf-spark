 ...
 *
 */
public class TabularReportSql implements Function<Tuple2<String, StructureDataInterface>, Boolean> {
	 ...
	 * @throws IOException
	 */
	public TabularReportSql(String whereClause, String... fields) throws IOException {
