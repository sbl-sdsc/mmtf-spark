 ...
 * 
 * <p> The "Structure Integration with Function, Taxonomy and Sequence" 
 * (<a href="https://www.ebi.ac.uk/pdbe/docs/sifts/overview.html">SIFTS</a>) 
 * is the authoritative source of up-to-date residue-level annotation of 
 * structures in the PDB with data available in UniProt, IntEnz, CATH, 
 * SCOP, GO, InterPro, Pfam and PubMed.
 *
 * <p> Data are provided through
 * <a href="https://pdbj.org/help/mine2-sql">Mine 2 SQL</a>
 * 
 * <p> Queries can be designed using the interactive 
