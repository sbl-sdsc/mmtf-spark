...
/**
 * This class downloads the dataset used to train the <a href=
 * "http://www.compbio.dundee.ac.uk/jpred/about_RETR_JNetv231_details.shtml">JPred
 * 4/JNet (v.2.3.1)</a> secondary structure predictor. It can be used as a
 * reference dataset for machine learning applications. This dataset includes
 * the ScopID, sequence, DSSP secondary structure assignment, and a flag that
 * indicates if data point was part of the training set.
 * 
 * @author Yue Yu
 * @since 0.1.0
 * 
...
public class JpredDataset {
	private static final String URL = "http://www.compbio.dundee.ac.uk/jpred/downloads/retr231.tar.gz";
